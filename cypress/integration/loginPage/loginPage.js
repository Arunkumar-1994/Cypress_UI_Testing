...
And('User enter valid details in the register page', () => {
    ...
    cy.registerAUser(data.title, data.firstName, data.surName, data.enterPhoneNumber, data.selectYear, data.selectMonth, data.selectDate, data.selectLicensePeriodYear, data.selectOccupation, data.selectLicensePeriodYear, data.enterAddress, data.enterCity, data.enterCountry, data.enterPostalCode, data.enterEmailAddress, data.enterPassword)
})
